...
> 本项目脱胎于作者与导演传奇合作的视频播客节目[《小径分岔的花园》](https://github.com/tyouter/auto-podcast-slicer)，用于该节目的日常制作。节目灵感来源于博尔赫斯同名短篇小说，而将制作工具开源，正是探索时间可能性的一个分支——开源行为本身即是时间分岔的一个选择，旨在践行"一切可能性同时发生"的理念。

播客视频全链路自动化制作框架。从"我有个想法"到"我有一整套平台成品"——一个人驱动一整支专业团队。

技术灵感来自 Karpathy 的 autoresearch 项目——将 AI 研究的自主迭代范式应用于播客视频制作领域。
